...
type EventProps = Omit<
  Event,
  'ticketText' | 'ticketUrl' | 'present' | 'other' | 'attention' | 'eventer'
>
      ...
      <div className='event-card'>
        ...
        <div className='detail-area'>
          ...
          <div className='footer-area'>
            {date ? (
              <div className='event-date flex gap-1'>
                <CalendarBlank size={18} className='translate-y-1' />
                {date}
              </div>
            ) : (
              <></>
            ...
            {openTime && startTime ? (
              <div className='event-time flex gap-1'>
                <Clock size={18} className='translate-y-1' />
            ...
            {placeName ? (
              <div
                className='event-place flex gap-1'
                style={{ fontSize: ResizeFontSize(placeName) }}
              >
                <MapPin size={18} className='translate-y-1' />
                {placeName}
              </div>
            ) : (
              ''
